gh run download $(gh run list -L 20 -R duckdb/duckdb -e workflow_dispatch -w InvokeCI --branch v1.3-ossivalis --json databaseId | jq "[.[]][$DAYS].databaseId") -R duckdb/duckdb --dir collect
